...
- **Timesheet** — employees log daily hours against a project they're assigned to (date, task description, hours), pending HR approval. HR approves/rejects entries and a Reports screen totals approved hours by project and by employee.
