...
// Data the "+ New Task" form needs: department list (sourced from employees' actual
// department field, same convention used for Notifications/Announcements targeting), and
// (HR only) an employee picker to assign to.
router.get('/tasks/options', (req, res) => {
  ...
  res.json({ departments, statuses: TASK_STATUSES, employees, isHR: isHR(req.user.role) });
});
